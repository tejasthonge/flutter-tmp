...
class AppPages {
  ...
  static const onDisplay =
      AppPage(path: "/always-on-display", name: "Always On Display");
  static const wifiProvision =
      AppPage(path: "/wifi-prevision", name: "Wifi Prevision");
...
class AppRouter {
  ...
  static final router = GoRouter(
    ...
    // initialLocation: AppPages.onDisplay.path,
    routes: [
      GoRoute(
      ...
      GoRoute(
        name: AppPages.wifiProvision.name,
        path: AppPages.wifiProvision.path,
        builder: (context, state) =>  WifiProvision(),
      ),
      // 
      ShellRoute(
