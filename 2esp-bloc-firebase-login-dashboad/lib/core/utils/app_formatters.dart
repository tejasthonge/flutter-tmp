...
class AppFormatters {
  ...
  static formatDateWithDay({required DateTime selectedDate}) {
    return DateFormat("d-EEEE-yyyy").format(selectedDate);
  }

  static formatTime({required DateTime selectedTime}) {
    return DateFormat("hh:mm:ss a").format(selectedTime);
  }
}
